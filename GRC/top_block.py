...
# Title: Top Block
# Generated: Thu Sep 24 11:35:49 2020
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.station_tuning = station_tuning = 99e6
        ...
        # Blocks
        ##################################################
        _station_tuning_sizer = wx.BoxSizer(wx.VERTICAL)
        self._station_tuning_text_box = forms.text_box(
        	parent=self.GetWin(),
        	sizer=_station_tuning_sizer,
        	value=self.station_tuning,
        	callback=self.set_station_tuning,
        	label='station_tuning',
        	converter=forms.float_converter(),
        	proportion=0,
        )
        self._station_tuning_slider = forms.slider(
        	parent=self.GetWin(),
        	sizer=_station_tuning_sizer,
        	value=self.station_tuning,
        	callback=self.set_station_tuning,
        ...
        self.Add(_station_tuning_sizer)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('fm_radio.wav', 1, int(48e3), 8)
    ...
    def set_station_tuning(self, station_tuning):
        ...
        self._station_tuning_slider.set_value(self.station_tuning)
        self._station_tuning_text_box.set_value(self.station_tuning)
        self.wxgui_fftsink2_0.set_baseband_freq(self.station_tuning)
